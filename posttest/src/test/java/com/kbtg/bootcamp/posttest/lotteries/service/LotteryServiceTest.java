...
public class LotteryServiceTest {
    ...
    public void TestFindTicketsAmountMoreThanZero(){
        List<Lottery> mockLotteries = List.of(
        ...
        TicketListResponseDTO expectedLotteries = new TicketListResponseDTO(List.of("000001", "000003", "123456"));
    ...
    public void testFindLotteryByTicketFailBecauseSoldOut(){
        ...
        assertThrows(NotFoundException.class, () -> lotteryService.findLotteryByTicketAmountMoreThanZero(mockTicket), "ticket sold out");
    }
}
